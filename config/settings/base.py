# -*- coding: utf-8 -*-
"""
Django settings for Guardsmen Auction Manager project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (auction/config/settings/base.py - 3 = auction/)
APPS_DIR = ROOT_DIR.path('auction')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'auction.contrib.sites.migrations'
}
