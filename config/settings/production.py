"""
Production settings for auction project.
...
elif DEFAULT_FILE_STORAGE == 'storages.backends.gcloud.GoogleCloudStorage':
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='auction <noreply@guardsmen.org>')
EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[auction]')
